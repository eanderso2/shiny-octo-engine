...
if at1 == ("wait till night"):
    ...
    game_over()
print("kidnapper 2 : me too")
time.sleep(1)
print("you sneek in and as you finish untying",friend_name,"kidnaper 1 wakes up")
print("kidnaper 1 : u wok i up")
print("you run deeper in the cave")
print("you hear water on the left")
print("you see a waterfall with light on the other side")
print("you go left")
